...
func main(){
	...
	lower_vel, lower_weight := first_stage_flight(160, float64(first_weight), 0, 0)
	center_vel, center_weight := second_stage_flight(386, lower_weight - float64(empty_lower), lower_vel)
	upper_vel, upper_weight := third_stage_flight(318, center_weight - float64(empty_center), center_vel)
